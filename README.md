...
Generation on default settings should take between 15 seconds and 4 minutes depending on task length.

This is a rough draft based on ~30 hours of testing.
It seems to work on qwen 2.5 1.5B and 7B, with 64-128 token outputs, anything else hasn't been tested in any moderately formal way.
